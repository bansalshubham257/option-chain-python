...
NIFTY_EXPIRY      = "2026-03-17"   # NIFTY options expiry
SENSEX_EXPIRY     = "2026-03-19"   # SENSEX options expiry (BSE_FO)
STOCK_FNO_EXPIRY  = "2026-03-30"   # NSE stock options expiry (OPTSTK)
...
FUT_MIN_TOTAL_LOTS       = 1035    # futures: require at least this many lots resting
